...
void light_recall_mode_set2(MS_ACCESS_MODEL_HANDLE recalled_model_handle, void* data2)
{
    UINT32 data;
    data = *(UINT32*)data2;
    light_recall_mode_set(recalled_model_handle, data);
}
API_RESULT init_attr_tbl_light(UI_DATA_ALIGENIE_MODEL_T* me)
{
    ...
    aliGenie_bleMesh_Generic_Scene_register_Recall_cb(me->model_handle,light_recall_mode_set2);
    return API_SUCCESS;
}
